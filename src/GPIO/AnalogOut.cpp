...
gpio::AnalogOut::AnalogOut(uint8_t pin, uint8_t pwm_ch, double freq, uint8_t resolution_bits) noexcept :
    pin_num(pin), pwm_channel(pwm_ch), frequency(freq), resol_bits(resolution_bits) {}
